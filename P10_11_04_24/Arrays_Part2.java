	...
	public static void main(String[] args) 
	{
		...
		/*
			...
			*/
			...
			int[] a = {10, 20, 40} ;
			System.out.println("Int Arrays is " + a);

			for( int i =0; i<3 ; i++ )
				System.out.println(a[i]);

			String[] names = {"Sachin", "Saurav", "Kohli"};
			System.out.println("String Arrays is " + names);

			float[] avg = {21.12f, 66.56f, 643.23f};
			System.out.println("Float Arrays is " + avg);
